...
Strictness ไปป์ไลน์หยุดทำงานทันทีที่เจอข้อมูลเสียเพียงแถวเดียว การทำให้ data warehouse
ทันสมัยอยู่เสมอ ระบบต้นทางมักมีข้อมูลไม่สมบูรณ์เป็นธรรมชาติ — ส่วนลดพิมพ์ผิด
สกุลเงินติดมาด้วย ลูกค้าที่ยังไม่ sync เข้าระบบ — ซึ่งอยู่นอกเหนือการควบคุม
ของไปป์ไลน์ ถ้าแถวเสียเพียงแถวเดียวสามารถทำให้ทั้งระบบล่มได้ แถวที่ถูกต้อง
